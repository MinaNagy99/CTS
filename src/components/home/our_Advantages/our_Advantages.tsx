...
//       image: "/assets/home/features1.png",
//     },
//     {
...
//         image: "/assets/home/features2.png",
//       },
//   ]);
  return (
    <>
          ...
          <div className=" p-3 my-5">
            <div className="row">
              <div className="col-md-6 p-3 col-12">
                ...
                <div className="row my-3">
                  <div className="col-2  d-flex justify-content-end  text-start">
                    <img
                      className="w-100 "
                      src="/assets/home/features2.png"
                      alt=""
                    />
                  </div>
                  <div className="col-9">
