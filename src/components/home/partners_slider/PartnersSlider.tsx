...
function PartnersSlider() {
    const partnersLogos = [
        ...
        "/assets/parteners/alhua-logo.png",
        "/assets/parteners/asus-logo.png",
        "/assets/parteners/axis-logo.png",
        "/assets/parteners/bosch.png",
        "/assets/parteners/cisco-logo.png",
        "/assets/parteners/d-link.png",
        "/assets/parteners/dell-logo.png",
        "/assets/parteners/hikvision.png",
        "/assets/parteners/hp-logo.png",
        "/assets/parteners/huawei-logo.png",
        "/assets/parteners/Kaspersky-Logo.png",
        "/assets/parteners/lenovo-logo.png",
        "/assets/parteners/leviton.png",
        "/assets/parteners/Microsoft-logo.png",
        "/assets/parteners/panduit-vector-logo.png",
        "/assets/parteners/prem line.png",
        "/assets/parteners/QNAP-logo.png",
        "/assets/parteners/sopho-logo.png",
        "/assets/parteners/Syno-logo.png",
        "/assets/parteners/yealink-logo.png",
    ];
