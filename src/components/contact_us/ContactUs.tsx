...
function ContactUs() {
    ...
    return (
        <>
            <div
                className={` d-flex justify-content-center align-items-center  containForm ${
                    submitted ? `handelVH-submited` : "handelVH-form"
                }`}
            >
                {submitted ? (
                            ...
                            <Form className="w-md-50   p-5 py-4  ">
                                ...
                                <div className="mb-3">
                                    ...
                                    <select name="service" className="form-select" required>
                                        ...
                                        <option
                                            selected={state?.name == "websiteDesign" ? true : false}
                                        ...
                                        <option value="تصميم متجر الكترونى">
                                        ...
                                        <option value="برمجة مواقع ووردبريس WordPress">
                                            <Trans i18nKey="WordPress website programming"></Trans>
                                        </option>
                                        <option selected={state?.name == "SEO" ? true : false} value="استضافة موقع">
                                ...
                                <div className="mb-3">
                                    ...
                                    <Field type="email" name="email" className="form-control email-input-with-icon pe-5" />
