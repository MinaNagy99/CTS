...
function ContactUs() {
  ...
  return (
    ...
    <div className="container-fluid">
      <div
        className={`bg-contact-gray  ${
          submitted ? `handelVH-submited` : "handelVH-form"
        } row`}
      >
        <div
          className={`  col-6  containForm `}
        >
          {submitted ? (
                ...
                <Form className="w-100 m-auto  py-4  ">
                  ...
                  <div className="mb-3">
                    ...
                    <select name="service" className="form-select" required>
                      ...
                      <option selected={state?.name == "onlineStore" ? true : false}  value="تصميم متجر الكترونى">
                      ...
                      <option selected={state?.name == "wordpress" ? true : false} value="برمجة مواقع ووردبريس WordPress">
                      ...
                      <option
                        selected={state?.name == "SEO" ? true : false}
                        value="SEO"
                      >
                  ...
                  <div className="mb-3">
                    ...
                    <Field
                      type="text"
                      name="name"
                      className="form-control name-input-with-icon"
                    />
                    <ErrorMessage
                      name="name"
                      component="div"
