  ...
  return (
    <>
      ...
      <div className="container-fluid p-0">
        <HeaderAndLines
          header={
            <Trans i18nKey="What distinguishes our e-commerce websites"></Trans>
          }
        ></HeaderAndLines>
        <div className="container">
          <div className="row mt-5 gy-4">
                ...
                imageOrSvg={
                  ...
                  >
                    <g clip-path="url(#clip0_1205_458)">
                      ...
                      />
                      <path
                        d="M3.50391 9.1543H38.4925V56.8455H3.50391V9.1543Z"
                        fill="#71C7E5"
                      />
                      <path
            ...
            <div className="col-12 col-md-6">
              <OnlineStoreFeatures
                imageOrSvg={"/assets/onlineStoreDesignImages/hosting.png"}
            ...
            <div className="col-12 col-md-6">
              <OnlineStoreFeatures
                imageOrSvg={"/assets/onlineStoreDesignImages/transaction.png"}
            ...
            <div className="col-12 col-md-6">
              <OnlineStoreFeatures
                imageOrSvg={"/assets/onlineStoreDesignImages/question.png"}
                title="Live chat"
            ...
            <div className="col-12 col-md-6">
              <OnlineStoreFeatures
                imageOrSvg={"/assets/onlineStoreDesignImages/translation.png"}
                title="Multilanguage"
            ...
            <div className="col-12 col-md-6">
              <OnlineStoreFeatures
                imageOrSvg={"/assets/onlineStoreDesignImages/shopping-cart.png"}
                title="shopping cart"
            ...
            <div className="col-12 col-md-6">
              <OnlineStoreFeatures
                imageOrSvg={"/assets/onlineStoreDesignImages/trade.png"}
            ...
            <div className="col-12 col-md-6">
              <OnlineStoreFeatures
                imageOrSvg={"/assets/onlineStoreDesignImages/ad.png"}
            ...
            <div className="col-12 col-md-6">
              <OnlineStoreFeatures
                imageOrSvg={"/assets/onlineStoreDesignImages/wishlist.png"}
                title="Wishlist"
            ...
            <div className="col-12 col-md-6">
              <OnlineStoreFeatures
                imageOrSvg={"/assets/onlineStoreDesignImages/email.png"}
