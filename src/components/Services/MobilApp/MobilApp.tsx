...
export default function MobilApp() {
  ...
  let OurAdvantage: OurAdvantageType[] = [
    ...
    },
    {
      ...
      description: (
        <Trans i18nKey="All mobile applications designed by Tech Village are subject to continuous development and improvements to keep pace with the best global developments."></Trans>
      ),
